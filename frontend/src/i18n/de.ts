...
const de = {
  ...
  'einstellungen.theme': 'Erscheinungsbild',
  'einstellungen.themeNote': 'Hell, dunkel oder wie dein Gerät.',
  'einstellungen.themeSystem': 'Automatisch',
  'einstellungen.themeLight': 'Hell',
  'einstellungen.themeDark': 'Dunkel',

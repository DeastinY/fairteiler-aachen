...
const ar: Messages = {
  ...
  'detail.nudgeAsk': 'هل نُعلمك عندما يُحضر أحدهم شيئًا هنا؟',
  'detail.nudgeYes': 'نعم، أعلمني',
  'detail.nudgeNo': 'لا، شكرًا',
  'detail.nudgeDone': 'الإشعارات مفعّلة.',
  'detail.correctData': 'صحّح بيانات هذا الـ Fairteiler',
  'detail.correctSubject': 'تصحيح: {name}',
  'detail.correctBody': 'مرحبًا،\n\nهناك خطأ في {name} (ID {id}):\n\n\n\n{url}',
  ...
  'mehr.feedback': 'ملاحظات والإبلاغ عن خطأ',
  ...
  'einstellungen.theme': 'المظهر',
  'einstellungen.themeNote': 'فاتح أو داكن أو حسب جهازك.',
  'einstellungen.themeSystem': 'تلقائي',
  'einstellungen.themeLight': 'فاتح',
  'einstellungen.themeDark': 'داكن',

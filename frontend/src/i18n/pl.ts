...
const pl: Messages = {
  ...
  'detail.nudgeAsk': 'Dać znać, gdy ktoś coś tu przyniesie?',
  'detail.nudgeYes': 'Tak, powiadamiaj',
  'detail.nudgeNo': 'Nie, dziękuję',
  'detail.nudgeDone': 'Powiadomienia są włączone.',
  'detail.correctData': 'Popraw dane tego Fairteilera',
  'detail.correctSubject': 'Poprawka: {name}',
  'detail.correctBody': 'Cześć,\n\ncoś się nie zgadza przy {name} (ID {id}):\n\n\n\n{url}',
  'filters.aria': 'Filtry',
  ...
  'mehr.feedback': 'Opinie i zgłoszenie błędu',
  ...
  'einstellungen.theme': 'Wygląd',
  'einstellungen.themeNote': 'Jasny, ciemny lub jak w urządzeniu.',
  'einstellungen.themeSystem': 'Automatycznie',
  'einstellungen.themeLight': 'Jasny',
  'einstellungen.themeDark': 'Ciemny',

...
const fr: Messages = {
  ...
  'detail.nudgeAsk': 'On te prévient quand quelque chose est déposé ici ?',
  'detail.nudgeYes': 'Oui, préviens-moi',
  'detail.nudgeNo': 'Non merci',
  'detail.nudgeDone': 'Notifications activées.',
  'detail.correctData': 'Corriger les infos de ce Fairteiler',
  'detail.correctSubject': 'Correction : {name}',
  'detail.correctBody': 'Bonjour,\n\nquelque chose ne va pas pour {name} (ID {id}) :\n\n\n\n{url}',
  ...
  'mehr.feedback': 'Retour & signaler une erreur',
  ...
  'einstellungen.theme': 'Apparence',
  'einstellungen.themeNote': 'Clair, sombre ou comme ton appareil.',
  'einstellungen.themeSystem': 'Automatique',
  'einstellungen.themeLight': 'Clair',
  'einstellungen.themeDark': 'Sombre',

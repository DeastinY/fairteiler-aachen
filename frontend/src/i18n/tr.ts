...
const tr: Messages = {
  ...
  'aktivitaet.followAria': '{name} için bildirimler',
  'aktivitaet.quietTitle': 'Sessiz saatler',
  'aktivitaet.quietNote': '21–8 arası bildirim yok',
  'aktivitaet.permissionBlocked':
    'Bildirimler tarayıcıda engellenmiş – tarayıcı ayarlarından tekrar izin verebilirsin.',
  'aktivitaet.subscribeFailed': 'Push aboneliği kurulamadı.',
  ...
  'install.caption':
    "Çevrimdışı çalışır, kendi simgesi olur – iOS'ta push bildirimleri yalnızca yüklü uygulamada çalışır.",
  ...
  'einstellungen.notifications': 'Bildirimler & sessiz saatler',
  ...
  'einstellungen.clearCaption':
    'Cihaz kimliğini, filtreleri, ayarları ve yerel bildirim seçimini bu tarayıcıdan kaldırır.',
  ...
  'regeln.careTitle': 'Yerinde düşün',

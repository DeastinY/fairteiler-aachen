...
const tr: Messages = {
  ...
  'detail.nudgeAsk': 'Buraya bir şey bırakıldığında haber verelim mi?',
  'detail.nudgeYes': 'Evet, haber ver',
  'detail.nudgeNo': 'Hayır, teşekkürler',
  'detail.nudgeDone': 'Bildirimler açık.',
  'detail.correctData': 'Bu Fairteiler bilgilerini düzelt',
  'detail.correctSubject': 'Düzeltme: {name}',
  'detail.correctBody': 'Merhaba,\n\n{name} (ID {id}) hakkında bir sorun var:\n\n\n\n{url}',
  ...
  'mehr.feedback': 'Geri bildirim ve hata bildirimi',
  ...
  'einstellungen.theme': 'Görünüm',
  'einstellungen.themeNote': 'Açık, koyu veya cihazına göre.',
  'einstellungen.themeSystem': 'Otomatik',
  'einstellungen.themeLight': 'Açık',
  'einstellungen.themeDark': 'Koyu',
